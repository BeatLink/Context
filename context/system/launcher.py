...
from context.system import adapters, backends, isolation
from context.system.backends import Backend, Workspace
from context.state.layout import split_directions
...
def _slot_from(client: dict, box: tuple[float, float, float, float]) -> "Slot":
    ...
    from context.state.layout import Slot
